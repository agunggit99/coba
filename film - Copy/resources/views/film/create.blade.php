  ...
  <div>
    <div class="panel">
      ...
      <div class="panel-body">
        <form action="{{ route('films.store') }}" method="POST" id="filmForm">
          @csrf

          {{-- Judul --}}
          <div class="fg">
            <label>Judul Film</label>
            <input type="text" name="judul" id="inp_judul" placeholder="Pandemic 1920" value="{{ old('judul') }}" required>
          </div>
          ...
          <div class="fg">
            ...
            <textarea name="deskripsi" id="inp_deskripsi" placeholder="Sinopsis film...">{{ old('deskripsi') }}</textarea>
          </div>
          ...
          <div class="form-row-2">
            <div class="fg">
              ...
              <input type="text" name="sutradara" id="inp_sutradara" placeholder="Nama sutradara" value="{{ old('sutradara') }}">
            </div>
            <div class="fg">
              <label>Tahun Rilis</label>
              <input type="date" name="tahun" id="inp_tahun" value="{{ old('tahun') }}">
            </div>
          </div>
          ...
          <div class="form-row-2">
            <div class="fg">
              ...
              <input type="number" name="rating" id="inp_rating" step="0.1" min="0" max="10" placeholder="8.5" value="{{ old('rating') }}">
            </div>
            <div class="fg">
              <label>Durasi</label>
              <input type="text" name="durasi" id="inp_durasi" placeholder="1 Jam 45 Menit" value="{{ old('durasi') }}">
            </div>
          </div>
          ...
          <div class="form-row-2">
            <div class="fg">
              ...
              <input type="text" name="thumbnail" id="inp_thumbnail" placeholder="https://... atau pilih file" value="{{ old('thumbnail') }}">
              <div style="margin-top:.5rem">
                <div class="upload-box" style="padding:.8rem;text-align:left;display:flex;align-items:center;gap:.7rem">
                  <input type="file" accept="image/*" onchange="previewPoster(this)">
            ...
            <div class="fg">
              ...
              <input type="text" name="video" id="inp_video" placeholder="https://youtube.com/..." value="{{ old('video') }}">
              <div style="margin-top:.5rem">
                <div class="video-upload-box">
                  ...
                  <label class="btn-upload-video">
                    ...
                    Unggah Video
                    <input type="file" accept="video/*" onchange="handleVideoFile(this)">
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="fg">
            ...
            <input type="text" name="subtitle" placeholder="https://..." value="{{ old('subtitle') }}">
          </div>
